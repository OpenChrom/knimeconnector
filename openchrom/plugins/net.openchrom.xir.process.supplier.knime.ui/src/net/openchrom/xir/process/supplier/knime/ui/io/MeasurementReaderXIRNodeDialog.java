 ...
 * @author OpenChrom
 */
public class MeasurementReaderXIRNodeDialog extends DefaultNodeSettingsPane {
	...
	protected MeasurementReaderXIRNodeDialog() {
		...
		//
		DialogComponentFileChooser dialogComponentFileChooser = new DialogComponentFileChooser(MeasurementReaderXIRNodeModel.SETTING_XIR_FILE_INPUT, "", validExtensions);
