...
import net.openchrom.xir.process.supplier.knime.table.ScanXirTableTranslator;
import net.openchrom.xir.process.supplier.knime.table.ScanXirTableTranslatorBackgroundSignals;
import net.openchrom.xir.process.supplier.knime.table.ScanXirTableTranslatorRawData;
