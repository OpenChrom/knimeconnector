...
public class ChromatogramReportTable extends DialogTable<ChromatogramReport> {
	...
	public ChromatogramReportTable(Collection<ChromatogramReport> init) {

		super(columnsName, columnsWidth, init, 800, JLabel.LEFT);
	}

	public ChromatogramReportTable() {

		super(columnsName, columnsWidth, 800, JLabel.LEFT);
	}

	@Override
	protected Object getValue(ChromatogramReport data, int columnIndex) {
	...
	@Override
	protected List<ChromatogramReport> add() {

		List<ChromatogramReport> chromatogramExports = new ArrayList<>();
		...
		if(result == JOptionPane.OK_OPTION) {
			...
			if(file.isDirectory()) {
				ChromatogramReport chromatogramExport = new ChromatogramReport(id, file);
