...
public class ChromatogramMSDExportTable extends DialogTable<IChromatogramMSDExport> {
	...
	public ChromatogramMSDExportTable(Collection<IChromatogramMSDExport> init) {
		super(columnsName, columnsWidth, init, 800, JLabel.LEFT);
	}

	@Override
	protected Object getValue(IChromatogramMSDExport data, int columnIndex) {
	...
	@Override
	protected List<IChromatogramMSDExport> add() {

		List<IChromatogramMSDExport> chromatogramExports = new ArrayList<>();
		...
		if(result == JOptionPane.OK_OPTION) {
			...
			if(file.isDirectory()) {
				IChromatogramMSDExport chromatogramExport = new ChromatogramMSDExport(id, file);
