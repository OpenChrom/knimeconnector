 ...
 *
 * @param <SO> the settings object - usually a bean-like class that represents all settings for the dialog to be generated. It must have an empty constructor and is usually mutable.
 */
