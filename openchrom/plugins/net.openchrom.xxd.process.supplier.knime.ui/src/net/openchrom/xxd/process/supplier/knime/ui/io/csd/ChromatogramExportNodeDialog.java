...
import net.openchrom.xxd.process.supplier.knime.ui.dialog.DialogComponentChromatogramCSDExport;
...
public class ChromatogramExportNodeDialog extends DefaultNodeSettingsPane {
	...
	protected ChromatogramExportNodeDialog() {
		super();
		addDialogComponent(new DialogComponentChromatogramCSDExport(ChromatogramExportNodeModel.getSettingsModelChromatogramCSDExport(), "Export Chromatogram"));
