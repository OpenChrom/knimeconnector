 ...
 * @author OpenChrom
 */
public class ChromatogramVizNodePlugin extends Plugin {
    // The shared instance.
    private static ChromatogramVizNodePlugin plugin;

    /**
     * The constructor.
     */
    public ChromatogramVizNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ChromatogramVizNodePlugin getDefault() {
        return plugin;
    }
