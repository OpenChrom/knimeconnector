 ...
 * @author OpenChrom
 */
public class MassSpectrumNodePlugin extends Plugin {

	// The shared instance.
	private static MassSpectrumNodePlugin plugin;
	 ...
	 */
	public static MassSpectrumNodePlugin getDefault() {
