 ...
 * @author OpenChrom
 */
public class MeasurementWriterNMRNodeModel extends NodeModel {
	...
	// the logger instance
	private static final NodeLogger logger = NodeLogger.getLogger(MeasurementWriterNMRNodeModel.class);
	// example value: the models count variable filled from the dialog
	// and used in the models execution method. The default components of the
	// dialog work with "SettingsModels".
	private final SettingsModelIntegerBounded m_count = new SettingsModelIntegerBounded(MeasurementWriterNMRNodeModel.CFGKEY_COUNT, MeasurementWriterNMRNodeModel.DEFAULT_COUNT, Integer.MIN_VALUE, Integer.MAX_VALUE);

	/**
	 * Constructor for the node model.
	 */
	protected MeasurementWriterNMRNodeModel() {
