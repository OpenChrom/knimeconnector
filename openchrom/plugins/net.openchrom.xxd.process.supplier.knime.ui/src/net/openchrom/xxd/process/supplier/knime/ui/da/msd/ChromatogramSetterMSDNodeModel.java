 ...
 * @author OpenChrom
 */
public class ChromatogramSetterMSDNodeModel extends NodeModel {

	// the logger instance
	private static final NodeLogger logger = NodeLogger.getLogger(ChromatogramSetterMSDNodeModel.class);
	/**
	...
	private final SettingsModelIntegerBounded m_count = new SettingsModelIntegerBounded(ChromatogramSetterMSDNodeModel.CFGKEY_COUNT, ChromatogramSetterMSDNodeModel.DEFAULT_COUNT, Integer.MIN_VALUE, Integer.MAX_VALUE);
