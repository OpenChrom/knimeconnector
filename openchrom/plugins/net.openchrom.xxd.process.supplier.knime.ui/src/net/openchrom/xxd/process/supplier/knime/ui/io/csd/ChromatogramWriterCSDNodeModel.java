 ...
 * @author OpenChrom
 */
public class ChromatogramWriterCSDNodeModel extends NodeModel {

	// the logger instance
	private static final NodeLogger logger = NodeLogger.getLogger(ChromatogramWriterCSDNodeModel.class);
	/**
	...
	private final SettingsModelIntegerBounded m_count = new SettingsModelIntegerBounded(ChromatogramWriterCSDNodeModel.CFGKEY_COUNT, ChromatogramWriterCSDNodeModel.DEFAULT_COUNT, Integer.MIN_VALUE, Integer.MAX_VALUE);

	/**
	 * Constructor for the node model.
	 */
	protected ChromatogramWriterCSDNodeModel() {
