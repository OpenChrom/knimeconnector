...
public class ProcessControllerStartNodeModel extends NodeModel implements LoopStartNode {
	...
	static SettingsModelString getProcessingType() {
		...
		return new SettingsModelString(ChromatogramSelectionMSDPortObjectSpec.PROCESSING_MODE, ChromatogramSelectionMSDPortObjectSpec.MODE_POSTPONED_PROCESSING);
	}
}
