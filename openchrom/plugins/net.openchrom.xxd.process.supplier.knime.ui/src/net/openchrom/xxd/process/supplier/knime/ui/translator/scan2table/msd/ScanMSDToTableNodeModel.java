...
public class ScanMSDToTableNodeModel extends NodeModel {

	protected static final boolean DEF_USE_TIC = false;
	private static final NodeLogger logger = NodeLogger.getLogger(ScanMSDToTableNodeModel.class);
	//
	...
	protected ScanMSDToTableNodeModel() {
