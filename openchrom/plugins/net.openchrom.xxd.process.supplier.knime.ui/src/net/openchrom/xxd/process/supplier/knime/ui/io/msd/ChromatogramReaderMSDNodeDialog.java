...
public class ChromatogramReaderMSDNodeDialog extends DefaultNodeSettingsPane {
	...
	protected ChromatogramReaderMSDNodeDialog() {
		super();
		addDialogComponent(new DialogComponentNumber(new SettingsModelIntegerBounded(ChromatogramReaderMSDNodeModel.CFGKEY_COUNT, ChromatogramReaderMSDNodeModel.DEFAULT_COUNT, Integer.MIN_VALUE, Integer.MAX_VALUE), "Counter:", /* step */ 1, /* componentwidth */ 5));
	}
}
