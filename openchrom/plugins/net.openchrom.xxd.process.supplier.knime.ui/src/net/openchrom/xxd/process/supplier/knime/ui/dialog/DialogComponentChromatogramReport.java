...
import net.openchrom.xxd.process.supplier.knime.ui.dialog.support.ChromatogramReportTable;
...
public class DialogComponentChromatogramReport extends DialogComponent {
	...
	private ChromatogramReportSerialization chromatogramOutputSerialization;

	public DialogComponentChromatogramReport(SettingsModelString model, String title) {
		super(model);
		chromatogramOutputSerialization = new ChromatogramReportSerialization();
