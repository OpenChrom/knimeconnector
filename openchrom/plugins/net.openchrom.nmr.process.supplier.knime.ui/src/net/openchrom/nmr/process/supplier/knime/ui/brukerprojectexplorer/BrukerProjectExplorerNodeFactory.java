 ...
 * @author OpenChrom
 */
public class BrukerProjectExplorerNodeFactory extends NodeFactory<BrukerProjectExplorerNodeModel> {
	...
	public NodeDialogPane createNodeDialogPane() {
		...
		return new BrukerProjectExplorerNodeDialog();
	}
	 ...
	 */
	@Override
	public BrukerProjectExplorerNodeModel createNodeModel() {

		return new BrukerProjectExplorerNodeModel();
	}
